...
package body Input_Callbacks is
   ...
   begin
      ...
      begin
         ...
         declare
            Out_Len     : constant Storage_Count := Result.Desc.Width * Result.Desc.Height * Result.Desc.Channels;
            Out_Data    : constant Storage_Array_Access := new Storage_Array (1 .. Out_Len);
            Output_Size : Storage_Count;
         begin
            QOI.Decode (Data => In_Data.all, Desc => Result.Desc, Output => Out_Data.all, Output_Size => Output_Size);
   ...
   procedure Spawn_Bullet(Entity: Entity_Access; Manager : access Entity_Manager_T'Class) is
   ...
   procedure Space_Key (Entity: Entity_Access; Manager : access Entity_Manager_T'Class; Dt : Duration; KeyDown: Boolean) is
      Cooldown   : constant Duration := 0.02;
   begin
      if KeyDown then
         Last_Fired := Last_Fired + Dt;
         if Last_Fired >= Cooldown then
            Spawn_Bullet(Entity, Manager);
   ...
   procedure W_Key(Entity: Entity_Access; Manager : access Entity_Manager_T'Class; Dt : Duration; KeyDown: Boolean) is
      Trans : Component_Access;
   ...
   begin
      ...
      Animation := Entity.all.Get_Component (Animation_Component_T'Tag);
      declare
         T renames Transform_T(Trans.all);
   ...
   procedure A_Key(Entity: Entity_Access; Manager : access Entity_Manager_T'Class; Dt : Duration; KeyDown: Boolean) is
      Trans : Component_Access;
      Animation : Component_Access;
   begin
      if Entity = null then
   ...
   procedure S_Key(Entity: Entity_Access; Manager : access Entity_Manager_T'Class; Dt : Duration; KeyDown: Boolean) is
      Trans : Component_Access;
      Animation : Component_Access;
   begin
      if Entity = null then
   ...
   procedure D_Key(Entity: Entity_Access; Manager : access Entity_Manager_T'Class; Dt : Duration; KeyDown: Boolean) is
      Trans : Component_Access;
      Animation : Component_Access;
   begin
      if Entity = null then
